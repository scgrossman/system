...
if (process.env.REACT_APP_ENV === 'staging') {
    ...
    sn_nav_url = 'https://int-www.sportsnet.ca/wp-json/sportsnet/v1/menu?1231211'
...
} else if (typeof process.env.REACT_APP_ENV == 'undefined') {
    stats_v2 = 'http://mobile-stats-int-1987921817.us-east-1.elb.amazonaws.com/api/v1'
    sn_url = 'https://int-www.sportsnet.ca'
    env_url = 'https://dczu06sbgnaj.cloudfront.net'
    brightcode_player_id = 'By5x5ZRLZ'
    ...
    sn_nav_url = 'https://www.sportsnet.ca/wp-json/sportsnet/v1/menu?1231211'
